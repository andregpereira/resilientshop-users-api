...
public record PaisRegistroDto(
		...
		@NotBlank(message = "Insira o código do país.") @Size(max = 45, message = "O código do país deve ter entre 2 e 3 caracteres") @Pattern(message = "Formato inválido. Formato: +xxx", regexp = "[+]\\d{3}") String codigo) {
