...
public record EnderecoRegistroUsuarioNovoDto(@NotBlank(message = "O apelido é obrigatório") String apelido,
        ...
        @NotBlank(message = "Insira a rua.") @Size(message = "A rua deve ter no máximo 45 caracteres.",
                max = 45) String rua,
        @NotNull(message = "Insira o número.") @Size(message = "O número deve ter no máximo 10 carecteres.",
