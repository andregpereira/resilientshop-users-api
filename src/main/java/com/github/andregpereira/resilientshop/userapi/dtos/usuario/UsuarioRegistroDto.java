...
public record UsuarioRegistroDto(
		...
		@NotBlank(message = "Insira o CPF.") @CPF(message = "Formato de CPF inválido. Formatos aceitos: xxx.xxx.xxx-xx, xxxxxxxxx-xx ou xxxxxxxxxxx")
//		@Pattern(message = "Formato de CPF inválido. Formatos aceitos: xxx.xxx.xxx-xx, xxxxxxxxx-xx ou xxxxxxxxxxx", regexp = "^(\\d{3}[.]\\d{3}[.]\\d{3}[-]\\d{2})|(\\d{9}[-]\\d{2})|(\\d{11})$")
		String cpf,
