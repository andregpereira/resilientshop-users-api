...
public record UsuarioRegistroDto(
		@NotBlank(message = "Insira o nome") @Size(message = "O nome deve ter no mínimo 2 caracteres", min = 2) @Size(message = "O nome deve ter no máximo 45 caracteres", max = 45) String nome,
		@NotBlank(message = "Insira o sobrenome") @Size(message = "O sobrenome deve ter no mínimo 2 caracteres", min = 2) @Size(message = "O sobrenome deve ter no máximo 250 caracteres", max = 250) String sobrenome,
