...
public class UsuarioDtoConstants {
    ...
    public static final UsuarioDto USUARIO_DTO = new UsuarioDto(null, "nome", "sobrenome", "22426853093",
    ...
    public static final UsuarioDetalhesDto USUARIO_DETALHES_DTO_ATUALIZADO = new UsuarioDetalhesDto(null, "nome2",
            "sobrenome2", "22426853093", "teste2@teste2.com", null, LOCAL_DATE, LOCAL_DATE, true, LISTA_ENDERECOS_DTO);

    public static final UsuarioDetalhesDto USUARIO_DETALHES_DTO_ATUALIZADO_PAIS_NOVO = new UsuarioDetalhesDto(null,
            "nome2", "sobrenome2", "22426853093", "teste2@teste2.com", null, LOCAL_DATE, LOCAL_DATE, true,
