...
public class UsuarioConstants {
    ...
    public static final Usuario USUARIO = new Usuario(1L, "nome", "sobrenome", "22426853093", null, LOCAL_DATE,
            LOCAL_DATE, true, LISTA_ENDERECOS);

    public static final Usuario USUARIO_SEM_ENDERECO = new Usuario(1L, "nome", "sobrenome", "22426853093", null,
    ...
    public static final Usuario USUARIO_MAPEADO = new Usuario(1L, "nome", "sobrenome", "22426853093", null, null, null,
            false, LISTA_ENDERECOS_MAPEADO);

    public static final Usuario USUARIO_PAIS_NOVO = new Usuario(1L, "nome", "sobrenome", "22426853093", null,
    ...
    public static final Usuario USUARIO_PAIS_NOVO_MAPEADO = new Usuario(null, "nome", "sobrenome", "22426853093", null,
            LOCAL_DATE, LOCAL_DATE, true, LISTA_ENDERECOS_PAIS_NOVO_MAPEADO);
    ...
    public static final Usuario USUARIO_ATUALIZADO_MAPEADO = new Usuario(1L, "nome2", "sobrenome2", null, null,
