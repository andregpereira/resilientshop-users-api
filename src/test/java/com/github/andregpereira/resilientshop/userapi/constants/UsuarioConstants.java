...
public class UsuarioConstants {
    ...
    public static final Usuario USUARIO_SEM_ENDERECO_MAPEADO = new Usuario(null, "nome", "sobrenome", "22426853093",
            "teste@teste.com", null, null, null, true, new ArrayList<>());
    ...
    public static final Usuario USUARIO_PAIS_NOVO_MAPEADO = new Usuario(null, "nome", "sobrenome", "22426853093",
            "teste@teste.com", null, null, null, true, LISTA_ENDERECOS_PAIS_NOVO_PADRAO_FALSE_MAPEADO);
    ...
    public static final Usuario USUARIO_ATUALIZADO_PAIS_NOVO = new Usuario(null, "nome2", "sobrenome2", "22426853093",
            "teste2@teste2.com", null, LOCAL_DATE, LOCAL_DATE, true, LISTA_ENDERECOS_PAIS_NOVO);
