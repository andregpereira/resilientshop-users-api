...
public class UsuarioConstants {
    ...
    public static final Usuario USUARIO_SEM_ENDERECO = new Usuario(null, "nome", "sobrenome", "22426853093", null,
    ...
    public static final Usuario USUARIO_ATUALIZADO_MAPEADO = new Usuario(null, "nome2", "sobrenome2", null, null, null,
            null, false, null);

    public static final Usuario USUARIO_ATUALIZADO_PAIS_NOVO = new Usuario(null, "nome2", "sobrenome2", "22426853093",
            null, LOCAL_DATE, LOCAL_DATE, true, LISTA_ENDERECOS_PAIS_NOVO);
